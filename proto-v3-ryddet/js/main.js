$(function() {
    ...
    function showInfo(json){
        $(".JStrack1")
            .append("<h4>" + events[0].title + "</h4>" + ("<div class='rooms '><i class='fa fa-map-marker' aria-hidden='true'></i> ") + events[0].room + ("</div>") + ("<div class='duration'>") + "Duration: " + events[0].duration + ("</div>"));
        $(".JStrack2")
